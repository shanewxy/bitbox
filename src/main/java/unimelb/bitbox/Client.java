        ...
        try {
            ...
            if (commandField != null) {
                if (commandField.equals("HANDSHAKE_RESPONSE")) {
                    // An exception would be catch if something goes wrong while parsing the
                    // hostPort field of the protocol
            ...
            // Any exception happened during parsing the protocol will make this protocol
            // invalid
            return -1;
        }
    }
