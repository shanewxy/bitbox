...
public class Client implements Runnable {
	...
	/**
	 * The ip address and port number of the peer that this client currently
	 ...
	 * 
	 * @param peer
	 *            the ip address and port number of the peer we want to connect
	 * @param handler
	 ...
	 * @return 1 the response is valid with a valid hostPort; 0 the response is
	 *         a connection refused protocol; -1 the response is invalid;
	 */
	 ...
	 * request is refused. This method may be recursively called if some of the
	 * the provided peers are full as well. The main algorithm of trying to
	 * connect with other peers follows the breadth first search principle.
	 * 
	 * @param peers
	 *            a list of peer candidates provided by previous full peer
